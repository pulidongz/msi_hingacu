...
class Location(models.Model):
    ...
    def __str__(self):
        return f"{self.site_name}, {self.barangay}, {self.town}, {self.province}"

class AL1Station(TimeStampModel):
...
class AL1Survey(TimeStampModel):
    ...
    station = models.ForeignKey(AL1Station, on_delete=models.SET_NULL, null=True)
...
class BeachProfilingSurvey(TimeStampModel):
    # when
    date = models.DateField()
